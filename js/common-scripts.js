(function ($) {
    ...
    $(function () {
        ...
        $('.slide-out-cross, .executive-modal-overlay').click(function () {
        ...
        $('.single-product-item').each(function () {
            var $$this = $(this);
            var interiorShower = $$this.find('.interior-shower img')
            console.log(interiorShower)
            $$this.find('.interior-trigger a').click(function (e) {
                e.preventDefault();
                var thisAttr = $(this).attr('href')
                interiorShower.attr('src', thisAttr)
            })
    ...
    $('.related-product-scroll .scrolling-text-content').css({
        'left': windowHeight
    });
